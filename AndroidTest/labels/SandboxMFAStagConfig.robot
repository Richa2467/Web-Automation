*** Variables ***
#### Constants  ####
${SurePassUrl}                  https://mfa-alpha.surepassid.com/home.aspx      # mfa-stag env URL
...
${GmailId}                      volspidqa3+1711220@gmail.com     # primary surepass account's gmail id
${GmailPassword}                fktkoujczycopxhz            #Volansys@123         # primary surepass account's gmail password

${inputEmailId}                 volspidqa3+1711221@gmail.com    # alias of gmailid1
${inputEmailId2}                volspidqa3+1711222@gmail.com
${inputEmailIdforHDUsr}         volspidqa3+1711223@gmail.com    # alias of gmailid1
...
${SuperGmailId}                      volspidqa3+1711224@gmail.com     # Super Admin surepass account's gmail id
